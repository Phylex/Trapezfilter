...
### Expansion connector with explicit mention of the cycle and speed tick
create_bd_port -dir I speed_tick_in
create_bd_port -dir I cycle_tick_in
create_bd_port -dir IO -from 5 -to 0 exp_p_tri_io
