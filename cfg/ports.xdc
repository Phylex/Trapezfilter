...
### Expansion connector
set_property IOSTANDARD LVCMOS33 [get_ports {speed_tick_in}]
set_property IOSTANDARD LVCMOS33 [get_ports {cycle_tick_in}]
set_property SLEW FAST [get_ports {cycle_tick_in}]
set_property SLEW FAST [get_ports {speed_tick_in}]
...
set_property PACKAGE_PIN K16 [get_ports {cycle_tick_in}]
set_property PACKAGE_PIN J16 [get_ports {exp_n_tri_io[6]}]
set_property PACKAGE_PIN M14 [get_ports {speed_tick_in}]
